...
CREATE TABLE `user_has_reviews` (
  ...
  KEY `fk_user_has_reviews_user1_idx` (`modified_user_id`),
  CONSTRAINT `fk_user_has_reviews_user1` FOREIGN KEY (`modified_user_id`) REFERENCES `user` (`id`),
...
-- Dump completed on 2020-11-08 10:20:21